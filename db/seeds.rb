...
Company.create!([
  {email: "company@gmail.com", password: 'password', name: 'company1', status: 'Active', confirmed_at: Date.today()},
  {email: "company2@gmail.com", password: 'password', name: 'company2', status: 'Active', confirmed_at: Date.today()},
  {email: "company3@gmail.com", password: 'password', name: 'company3'}
])
...
CustomerRequest.create!([
  {address: "2600 Lawrence ave", city: "Chicago", state: "IL", zipcode: "60625", service_category_id: 1, description: "I need a TV mounted in my living room.", customer_id: 1, expires_date: "2021-12-31", latitude: 41.9687556, longitude: -87.6939721}
])
Quote.create!([
